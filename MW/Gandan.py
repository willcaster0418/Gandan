...
class Gandan:
	...
	def pubsub(self, _pub, _req, _t, _msg):
		...
		if _cmd == "PUB" and _topic == "OM" and _req.getsockname()[0] != '127.0.0.1':
			raise Exception("Invalid Access to PUB OM from %s" % _req.get_sockname()[0])
			_req.close()
